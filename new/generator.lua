...
type_on_stack = function(t)
	...
	if type(t)=='string' or t.xarg.type_base==typename then
		...
		elseif t.xarg.indirections then
			error'I cannot manipulate pointers'
		else
...
-- function_is_destructor
-- function_takes_this_pointer
function_arguments_on_stack = function(f)
	...
	if f.xarg.member_of and not (f.xarg.static=='1') and f.xarg.member_of~='' then
